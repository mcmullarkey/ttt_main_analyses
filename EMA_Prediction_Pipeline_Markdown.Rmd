...
cdi_data_init %>% 
  ...
  labs(title = "Distribution of 'Bad' EMA Ratings Grouped by Participant",
    subtitle = "Minimum Value is 0 and Maximum Value is 100",
    x = "Bad")

ggsave('bad_distribution.jpg')

```

## Creating Table of Summary Statistics for Bad by Participant
