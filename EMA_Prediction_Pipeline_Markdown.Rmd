...
These plots can be in the supplement only (this document!)
...
Yes, this model performs equivalently on RMSE and R^2 compared to the best performing models on both metrics using time series data.
